...
import com.example.bccintern3.home.discovery.DiscoveryFragmentDetailDesainer
    ...
    fun bind(id:Int){
        ...
        clickableArea.setOnClickListener {
            Handler().postDelayed({
                ...
                loadFrag.transfer(mainFlManager,R.id.homeactivity_flmanager,DiscoveryFragmentDetailDesainer(mainFlManager,thisContext,navbar,activity,uid,idKategori))
            },1500)        }
    }
}